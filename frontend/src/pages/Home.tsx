...
const SHI_JI_QUOTES = [
  ...
  { quote: '今者项庄拔剑舞，其意常在沛公也。', source: '《史记·项羽本纪》' },
  { quote: '吾入关，秋毫不敢有所近。', source: '《史记·项羽本纪》' },
  { quote: '富贵不归故乡，如衣绣夜行。', source: '《史记·项羽本纪》' },
  { quote: '楚虽三户，亡秦必楚。', source: '《史记·项羽本纪》' },
  { quote: '王侯将相宁有种乎。', source: '《史记·陈涉世家》' },
  { quote: '苟富贵，无相忘。', source: '《史记·陈涉世家》' },
  { quote: '燕雀安知鸿鹄之志。', source: '《史记·陈涉世家》' },
  { quote: '高祖置酒洛阳南宫。', source: '《史记·高祖本纪》' },
  { quote: '安得猛士兮守四方。', source: '《史记·高祖本纪》' },
  { quote: '天下方扰，诸侯并起。', source: '《史记·高祖本纪》' },
  { quote: '多多益善耳。', source: '《史记·淮阴侯列传》' },
  { quote: '狡兔死，良狗烹；高鸟尽，良弓藏。', source: '《史记·越王勾践世家》' },
  { quote: '飞鸟尽，良弓藏；狡兔死，走狗烹。', source: '《史记·淮阴侯列传》' },
  { quote: '智者千虑，必有一失；愚者千虑，必有一得。', source: '《史记·淮阴侯列传》' },
  { quote: '积羽沉舟，群轻折轴。', source: '《史记·张仪列传》' },
  { quote: '忠言逆耳利于行。', source: '《史记·留侯世家》' },
  { quote: '夫运筹策帷帐之中，决胜于千里之外。', source: '《史记·高祖本纪》' },
  { quote: '一沐三握发，一饭三吐哺。', source: '《史记·鲁周公世家》' },
  { quote: '天下熙熙，皆为利来；天下攘攘，皆为利往。', source: '《史记·货殖列传》' },
  { quote: '前事之不忘，后事之师。', source: '《史记·秦始皇本纪》' },
  { quote: '毛羽未成，不可以高蜚。', source: '《史记·苏秦列传》' },
  { quote: '明修栈道，暗度陈仓。', source: '《史记·高祖本纪》' },
  { quote: '先发制人，后发制于人。', source: '《史记·项羽本纪》' },
  ...
  { quote: '疑行无名，疑事无功。', source: '《史记·商君列传》' },
  { quote: '人弃我取，人取我与。', source: '《史记·货殖列传》' },
  { quote: '骐骥之跼躅，不如驽马之安步。', source: '《史记·淮阴侯列传》' },
  { quote: '以权利合者，权利尽而交疏。', source: '《史记·郑世家》' },
  { quote: '其身正，不令而行；其身不正，虽令不从。', source: '《史记·李将军列传》' },
  { quote: '君子盛德，容貌若愚。', source: '《史记·留侯世家》' },
] as const;
